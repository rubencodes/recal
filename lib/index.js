...
function (_React$PureComponent) {
  ...
  _createClass(CalendarController, [{
    ...
    value: function isDateFocused(date) {
      return (0, _is_same_day.default)(date, this.state.focused);
    }
  }, {
    key: "isDateHovered",
    value: function isDateHovered(date) {
      return (0, _is_same_day.default)(date, this.state.hovered);
    }
  }, {
    key: "isDateSelected",
    ...
    value: function isDateInRange(date) {
      ...
      var endRange = endDate || (startRange && focused && !(0, _is_same_day.default)(startRange, focused) ? focused : hovered);
      if (!startRange || !endRange || (0, _is_before.default)(endRange, startRange)) return false;
      return (0, _is_within_range.default)(date, startRange, endRange);
    }
  }, {
